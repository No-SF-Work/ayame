...
scp test_results.tar pi@192.168.0.3:~/ci_functional/test_results.tar
echo -e "\033[32m\033[1m[Sent.]\033[0m"

echo -e "\033[32m\033[1m[Uncompressing on PI...]\033[0m"
ssh pi@192.168.0.3 "cd ci_functional; rm -rf build; mkdir -p build/log; tar xf ~/ci_functional/test_results.tar"

echo -e "\033[32m\033[1m[Running on PI...]\033[0m"
ssh pi@192.168.0.3 "cd ci_functional; python3 pi_scripts/test_std.py"