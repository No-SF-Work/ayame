            ...
            while (!done) {
                ...
                Runnable selectSpill = () -> {
                    ...
                    var m = spillWorklist.stream().max((l, r) -> {
                        var value1 = degree.getOrDefault(l, 0).doubleValue() / Math.pow(1.8, loopDepth.getOrDefault(l, 0));
                        var value2 = degree.getOrDefault(r, 0).doubleValue() / Math.pow(1.8, loopDepth.getOrDefault(r, 0));
